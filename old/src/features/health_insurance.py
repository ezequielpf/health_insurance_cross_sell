...
class HealthInsurance:
    ...
    def __init__(self):
        self.home_path = '/home/ezequiel/Documentos/Comunidade_DS/health_insurance_cross_sell/'
        self.age_feature = pickle.load(open(self.home_path + 'models/age_feature.pkl', 'rb'))
        self.annual_premium_feature = pickle.load(open(self.home_path + 'models/annual_premium_feature.pkl', 'rb'))
        self.gender_feature = pickle.load(open(self.home_path + 'models/gender_feature.pkl', 'rb'))
        self.policy_sales_channel_feature = pickle.load(open(self.home_path + 'models/policy_sales_channel_feature.pkl', 'rb'))
        self.region_code_feature = pickle.load(open(self.home_path + 'models/region_code_feature.pkl', 'rb'))
        self.vehicle_age_feature = pickle.load(open(self.home_path + 'models/vehicle_age_feature.pkl', 'rb'))
        self.vintage_feature = pickle.load(open(self.home_path + 'models/vintage_feature.pkl', 'rb'))
